    ...
    <div className={style.mainContainer}>
      <div className={style.mainInfoBlock}>
        ...
        <p className={style.textStyle}>
          Менеджер Турнирной Информации (МТИ) —
          это единое пространство для людей, которые делают и любят
          научные турниры, такие как ТЮ<span style={{color: "#1e2ede"}}>Ф</span> (Турнир Юных Физиков) и ТЮ<span style={{color: "rgb(94, 225, 118)"}}>E</span> (Турнир Юных
          Естествоиспытателей). Мы создаём
          систему, где турнирная жизнь
          становится прозрачной и удобной: от регистрации и сеток боёв до
          статистики, дипломов и истории достижений. Наша цель — чтобы любая
          команда, жюри и оргкомитет могли работать в одном месте, без
          бесконечных таблиц и ручной рутины.
        </p>
        <h1 className={style.headerStyle}>Наша миссия</h1>
        <p className={style.textStyle}>
          Сегодня информация о турнирах разбросана по разным площадкам,
          процесс регистрации неудобен, а у организаторов много повторяющейся
          ручной работы: от генерации дипломов до сводных таблиц и рассадок.
          Командам приходится на каждом турнире ориентироваться по разным системам (От excel до отдельных турнирных
          платформ).
          Плюс, сложно сопоставлять статистику между разными турнирами и оценивать
          опыт кандидатов в команду. Мы решаем все эти боли «под одной крышей».
        </p>
