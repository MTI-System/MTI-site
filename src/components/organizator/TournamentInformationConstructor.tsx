          ...
          <>
            <div className="flex flex-col justify-between">
              <div className="flex justify-between">
                <div className="flex gap-2">
                  ...
                  <Dropdown
                    trigger={
                      <DropdownTrigger
                        className={twclsx("bg-bg-alt hover:bg-hover h-full w-[10rem] justify-between rounded-full")}
                      >
                        {"Текст"}
                      </DropdownTrigger>
                    }
                ...
                <button className="mt-2 h-[2.5rem] w-[6rem] rounded-2xl border border-[#ED0F4E] bg-[#ED0F4E]/20 text-[#ED0F4E] hover:bg-[#ED0F4E]/50">
                  Удалить
                </button>
              </div>
              {material.contentType.type_name === "Text" ? (
                <>
                  <textarea
                    className="border-border mt-2 h-20 w-full resize-none rounded-2xl border-[1px] p-2 text-xs"
