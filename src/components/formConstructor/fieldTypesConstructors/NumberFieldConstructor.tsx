  ...
  return (
    <>
      <div className="flex justify-between mt-1">
        <label className="text-[0.9rem]" id={"placeholderInput"}>Минимальное числовое значение</label>
      ...
      <div className="flex gap-2 justify-between mt-1">
        <label className="text-[0.9rem]" id={"placeholderInput"}>Максимальное числовое значение</label>
        <input type={"number"} onInput={(e) => {
          debouncedUpdateProperties({
            fieldType: "number", maxValue: Number(e.currentTarget.value),
