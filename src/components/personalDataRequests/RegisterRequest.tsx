...
const fieldRootClass = "flex w-full flex-col items-start gap-1 text-text-main bg-bg-alt"
...
const inputClass =
  "h-15 w-full rounded-xl border border-border bg-bg-alt px-4 text-lg text-gray-900 placeholder:text-gray-400 transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2 focus-visible:ring-offset-white"
...
const datePickerClass =
  "outline-none flex h-15 w-full items-center justify-between rounded-xl border border-border bg-bg-alt px-4 text-lg text-gray-900 transition duration-200 focus-within:ring-2 focus-within:ring-accent-primary focus-within:ring-offset-2 focus-within:ring-offset-white"
const policyCardClass =
  "flex w-full h-15 flex-col gap-3 rounded-xl border border-border bg-bg-alt text-text-main p-4 text-sm leading-relaxed text-gray-900 sm:flex-row sm:items-center sm:justify-between sm:gap-4 select-none"
const checkboxRootClass =
  "flex size-5 items-center justify-center rounded-md border border-gray-300 bg-bg-alt transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2 focus-visible:ring-offset-white data-checked:border-transparent data-checked:bg-gray-900"
