        ...
        <div className={"w-full px-10 min-h-[50vh] "}>
          <Tabs.Root className="rounded-md border border-gray-200 size-full" defaultValue="player">
            <Tabs.List className="relative z-0 flex gap-1 px-2 shadow-[inset_0_-1px] shadow-gray-200 w-full justify-between">
              <Tabs.Tab
                className="cursor-pointer flex flex-1 h-8 items-center justify-center border-0 px-2 text-sm font-medium break-keep whitespace-nowrap text-gray-600 outline-none select-none before:inset-x-0 before:inset-y-1 before:rounded-sm before:-outline-offset-1 before:outline-blue-800 hover:text-gray-900 focus-visible:relative focus-visible:before:absolute focus-visible:before:outline-2 data-active:text-gray-900"
                value="player"
              >
                Участник
              </Tabs.Tab>
              ...
              <Tabs.Tab
                className="pointer-events-none flex flex-1 h-8 items-center justify-center border-0 px-2 text-sm font-medium break-keep whitespace-nowrap text-gray-600 outline-none select-none before:inset-x-0 before:inset-y-1 before:rounded-sm before:-outline-offset-1 before:outline-blue-800 hover:text-gray-900 focus-visible:relative focus-visible:before:absolute focus-visible:before:outline-2 data-active:text-gray-900"
                value="jury"
              >
                Жюри
              </Tabs.Tab>
