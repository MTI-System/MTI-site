    ...
    <div className="text-text-main border-border overflow-hidden rounded-2xl border">
      <Accordion.Root className="bg-bg-alt flex w-full flex-col justify-center">
        <Accordion.Item className="">
          <Accordion.Header>
            <Accordion.Trigger className="group text-text-main bg-bg-accent hover:bg-hover relative flex w-full items-baseline justify-between gap-4 py-5 pr-1 pl-3 text-left text-2xl font-medium focus-visible:z-1 focus-visible:outline focus-visible:outline-blue-800">
              {containerTitle}
            </Accordion.Trigger>
          </Accordion.Header>
