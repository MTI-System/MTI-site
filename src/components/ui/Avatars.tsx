...
const Cell = ({juryID}:{juryID: number}) => {
        ...
        return(
        <div className='flex flex-col text-text-main text-center text-wrap justify-center items-center'>
          <Avatar.Root className="uppercase inline-flex size-12 sm:size-12 mb-2 items-center justify-center overflow-hidden rounded-full bg-hover align-middle text-base font-medium text-text-main select-none">
